...
Where 𝜙 is the phase lag (a number less than 0). This is the phase as read from the vertical axis of the phase plot at the gain crossover frequency.

For example, the phase lag is -189°. Hence the phase margin is equal to -189° – (-180°) = -9° (unstable).
